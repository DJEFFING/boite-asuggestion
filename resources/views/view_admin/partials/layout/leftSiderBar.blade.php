				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href=" {{route('admin.acceuill')}} ">Dashboard</a></li>
							</ul>
						</li>
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								><span class="mtext">Suggestions</span>
							</a>
							<ul class="submenu">
								<li><a href="{{route('admin.categorie.index')}}">Categorie</a></li>
								<li>
									<a href="{{route('admin.user.suggestion.toutes_suggestions')}}">List Suggestion</a>
								</li>

								<li>
									<a href="{{route('admin.user.suggestion.suggestions_privees')}}">Sugg Privé</a>
								</li>
								<li><a href="{{route('admin.user.suggestion.suggestions_approuvees')}}">Sugg Aprouver</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								<span class="micon bi"><i class="icon-copy bi bi-person-fill"></i></span
								><span class="mtext">Utilisateur</span>
							</a>
							<ul class="submenu">
								<li><a href="{{ route('admin.user.userList.index') }}">List User</a></li>
								<li><a href="datatable.html">Actif User</a></li>
							</ul>
						</li>
						<li>
							<a href="{{route('admin.user.userList.listUserAdmin')}}" class="dropdown-toggle no-arrow {{Route::currentRouteName()=='admin.user.userList.listUserAdmin'?'active':''}}">
								<span class="micon bi"><i class="icon-copy bi bi-person-plus-fill"></i></span
								><span class="mtext">Administrateur</span>
							</a>
						</li>
						{{-- <li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
